...
class TraceCollector:
    ...
    def __call__(self, sensors: RobotSensors) -> RobotCommand:
        ...
        record = {
            ...
            "wall_front_m": diagnostics.features.wall_front * parameters.lidar_cap_m,
            "lidar_front_m": diagnostics.features.lidar_front * parameters.lidar_cap_m,
            "wall_front_left_m": diagnostics.features.wall_front_left * parameters.lidar_cap_m,
            "wall_front_right_m": diagnostics.features.wall_front_right * parameters.lidar_cap_m,
